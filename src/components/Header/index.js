...
const Header = (props) => {
  ...
  return (
    <header className="header-root bg-white flex justify-around">
      <Link to="/gocomet-assessment" className="text-base font-bold">
        xMyntra<img src={myntra} alt='xMyntra Logo' style={{ maxwidth: '60%' }} />
      </Link>
